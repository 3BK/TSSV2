...
Function msrdNetTracingStart {
    ...
    $Commands = @(
        "netsh trace start scenario=netconnection maxsize=2048 filemode=circular overwrite=yes report=yes tracefile=$TraceFilePath 2>&1 | Out-File -Append $global:msrdOutputLogFile"
    )
...
Function msrdNetTracingStop {
    ...
    $Commands = @(
        "netsh trace stop 2>&1 | Out-File -Append $global:msrdOutputLogFile"
    )
    msrdRunCommands $msrdLogPrefix $Commands -ThrowException:$False -ShowMessage:$True -ShowError:$True
}
...
Function msrdRunUEX_NetTracing {
    ...
    msrdLogMessage Info -Message "$(msrdGetLocalizedText "netTrace")`n" -Color "Cyan"
    ...
    if (!(($global:msrdGUIform -and $global:msrdGUIform.Visible))) {
        ...
        if ($traceanswer -eq 1) {
            msrdLogMessage Info -Message "$(msrdGetLocalizedText 'netTraceStopping')"
            msrdNetTracingStop
    ...
    msrdLogMessage Info -Message "$(msrdGetLocalizedText "netTraceFinished")`n" -Color "Cyan"
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDEUIOA681tfhiH
# dTwkzMTz6H7DWfx3bqM3GCzcjpj42qCCDYUwggYDMIID66ADAgECAhMzAAADTU6R
...
# suMVP/m5K7RU5ytEfdiINWiwpt2DppWgL1eQ2a5HMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAJoNtbIWkuTCF9s3u7UxAU1CS82wuDBGonZGB
# ymj2MCUKyKJvKxetdPYq6wghJUNezRjyOTVuXYyI3Ymlmb/kvIAVIYIKtUnkiy1e
# bZV7RQeYiDXma+ZLXIBY+9Cosl08ph1SnjPc8T6aB/r1yA/SKdgQS5YX8c37p+lX
# Xx5bBzTcVYCQwtCXGen8p2hVNdzKhbeAlPF1yvt42AxRypMVKIkHC85Roi/Czds+
# rhnTXbryPBRldW9esNSBI6eMUxED1+Wn4qGD+SH0ubZOny8eCYKDvVbNtV4B1hm+
# ftw+qqkFRsb/ZXa4gJAL9FAEnooUn5gceHYvKvGCi5z6QSeKoKGCFv4wghb6Bgor
# BgEEAYI3AwMBMYIW6jCCFuYGCSqGSIb3DQEHAqCCFtcwghbTAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCAKzjLmfv+dg9rK+SMj8VLmDq+0rt5IDtRi
# ltYae7NcHwIGZGzBYiUhGBMyMDIzMDUyMzE0NDQ1NC42MjlaMASAAgH0oIHQpIHN
# MIHKMQswCQYDVQQGEwJVUzETMBEGA1UECBMKV2FzaGluZ3RvbjEQMA4GA1UEBxMH
# UmVkbW9uZDEeMBwGA1UEChMVTWljcm9zb2Z0IENvcnBvcmF0aW9uMSUwIwYDVQQL
# ExxNaWNyb3NvZnQgQW1lcmljYSBPcGVyYXRpb25zMSYwJAYDVQQLEx1UaGFsZXMg
# VFNTIEVTTjpERDhDLUUzMzctMkZBRTElMCMGA1UEAxMcTWljcm9zb2Z0IFRpbWUt
# U3RhbXAgU2VydmljZaCCEVUwggcMMIIE9KADAgECAhMzAAABxQPNzSGh9O85AAEA
...
# MTAwDQYJKoZIhvcNAQEFBQACBQDoFz/iMCIYDzIwMjMwNTIzMjEzNjM0WhgPMjAy
