...
Function msrdCollectUEX_AVDActivationLog {
    ...
    msrdLogMessage Info "$(msrdGetLocalizedText "actmsg")" #Collecting machine Licensing/Activation troubleshooting data
    ...
    if ($varsActivation[0]) {
        If (!($global:msrdOSVer -like "*Server*2008*")) {
            $licdiagfile = $global:msrdSysInfoLogFolder + $global:msrdLogFilePrefix + "licensingdiag.cab"
            $Commands = @(
    ...
    if ($varsActivation[1]) {
        $Commands = @(
            "cscript C:\Windows\System32\slmgr.vbs /dlv 2>&1 | Out-File -Append " + $global:msrdSysInfoLogFolder + $global:msrdLogFilePrefix + "slmgr-dlv.txt"
        )
        msrdRunCommands $msrdLogPrefix $Commands -ThrowException:$False -ShowMessage:$True -ShowError:$True
    }
    ...
    if ($varsActivation[2]) {
        ...
        Try {
            ...
            $dom = $vmdomain.Name
            $kmsf = $global:msrdSysInfoLogFolder + $global:msrdLogFilePrefix + "KMS-Servers.txt"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC9wv/jDOgtM7AH
# nJwApiMYmZWjnkeh6q5VsnQykL7BaaCCDYUwggYDMIID66ADAgECAhMzAAADTU6R
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIEk0
# H+JmLGxFiGYwUCKz4bRnYbDNtDxSBveiyDb+Pox6MEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAz359fru2jJbeQHmpvnzAbBcayx9cKugGZ7x4
# iDj/7PNhSqAuEL1/HOf7f+Gyn6dZ3dlZcGK469saH7U2xQ8vo1VatT77tBcxOnfX
# CuteQZqHF/mKSDUl/ucoOxMOumFLZj31IQsDNH581AIvR1qg+Qs2qZzSX+4uYQSL
# zAA3Ja3yBvE6hFXsHcsh6eIYCmiQeTqi3PAX/PxiHRwBrhw1oSQCsN/dKytIVz91
# OlIDDdsvwKLnYjclrftlAwBTe2/l2JAHv+Uer8kHNfMqwfr6PAYoqPcKVwpPiOo2
# QrkVM+OjA7twafqKou9uHMzpF1R+iJeH7t4L7BJjz1HG4vAlU6GCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCCceepVLac+VcqGx/Rg7z5XlkMkwRBBUQJ3
# QybvEUMu5wIGZF1yocM4GBMyMDIzMDUyMzE0NDQ1Mi4yNTlaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEIFh7UwadqMTnSQq8+or1di/wvNAcyLfxSCi+
# /ZuDRCD7MIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQg0vtTm2+SSerh1KiA
...
# C9E+utsWnslP5tXR8f9Topy7bjANBgkqhkiG9w0BAQsFAASCAgA/vL1qq3lSkWCp
# xoLW6MCaxieXSq1636pPK74A2YbbIllPsF22hO2eGf4NC+hqXz6qyjwytpiYtkme
# UoZNTaHjSeNLAYQ8055oUpQVcKwEyqeEyEp7FHtUe/he1jEkyqNawy5Jf9gpAPmD
# mPjFw9hOVtuXYxUIzkE9zdDGVHOyKaXyNnvK5jpUDyzxRwUCamexJUDgVgmOVOGa
# GDDNZFubTcQoAATK6LOu6T9J+rF2KcWgwGqDi1w5ph375K6TmolgQy0lOIkxNKL8
# UkNfsdYFuaxur2Gmd4tlHTGZEXW3QcaSJGuTcBf7Urv5AWjgpp1ab0EcqSZXvGy4
# qhfEoTFGARMhO8lV1aBaMGYVU5t1mv4hBNEl8inyR0nqP6BUBCGgDxVU5cZQkfqP
# G2jYwqRb90OvMk+zFJqx6mo7miM9ZiXGY2BJwf0VelBtuKKYL/WPxOL/Ytty2M+s
# Jzs8uPLvzsmI+JXs6WefGeJrC4HzEXGEC50h3PpuykJoVi+zfU+6xV8VfQwbUHnG
# 3Xxp1irAHPhjg49ldN/q8OX5Fkk3WJeJAEUVIe9eHdx8H8ULkmH5so61HUPJUqm9
# 7gtkWVw0FzePDoxAqfqj2OuPp7ntkSrgUVZoxlPorjFSwrJy1tcD4t95vk7It3JG
# 9neP8Y81RqCqgCT6oAqzSjfJfnming==
