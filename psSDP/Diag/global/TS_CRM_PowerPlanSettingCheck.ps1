...
Write-DiagProgress -Activity $LocalizedMessages.PROGRESSBAR_ID_CRM_POWERPLAN_CHECK -Status $LocalizedMessages.PROGRESSBAR_ID_CRM_POWERPLAN_CHECKDesc

"--> Entered TS_CRM_PowerPlanSettingCheck.ps1" | WriteTo-StdOut
$RootCauseDetected=$false
 
 $active_plan = Get-WindowsPowerPlan
 if ($active_plan -ne " " -and $active_plan.toLower() -ne "high performance"){
 	$RootCauseDetected = $true
	Write-GenericMessage -RootCauseID "RC_PowerPlanNotHighPerformance" -Verbosity "Warning" -SolutionTitle "Degraded overall performance on Windows Server " -PublicContentUrl "http://support.microsoft.com/kb/2207548/en-us" -ProcessName "W3WP.exe" 
 }

if ($RootCauseDetected -eq $true)
{
	Update-DiagRootCause -Id "RC_PowerPlanNotHighPerformance" -Detected $true 
	if ($Error.Count -gt 0)
	{
	...
	Update-DiagRootCause -Id "RC_PowerPlanNotHighPerformance" -Detected $false 
}
"<-- Exited TS_CRM_PowerPlanSettingCheck.ps1" | WriteTo-StdOut

# SIG # Begin signature block
# MIInwwYJKoZIhvcNAQcCoIIntDCCJ7ACAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCr5kx21gUFkTEx
# +dFi7sLEmk2nC0EBWYkpCOXqabJhKqCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIM6scAssSuO5zAFMzyYQMQcZ
# bA0ImxmdCVw8oEMbU3sTMEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCAQCF6jW1Ny+v/4IsB1oOidXK14VJM83m1WwXdfXCgRjHYBV/NES2QQHV
# A1H873OIJ2i9qTeU6F62w92leATCJJBzFwAcj4emY+3UrB2oNtNXxigMfDUlP6TV
# IyS18jJ/v63tTiRfYx1XQNK0BhTvKJC3LVbx/3jnOA5MfDzgmMGGXWJfBlwkdI+3
# a3HIaVINk3o9truH73cvootSNSFmoWXZ2/Wu39bzuEIPvrd4gVlYHh30d8JGVnCV
# GmmBuCN5Hw50vATYIQ2/Ax+KY1px5B1Bb0uWfN52+nZ9nm95CoUu4BRNcq+ETdDR
# U1wThbmc3ymsEQG19Bc/nTGrZN5H2dIBoYIXKzCCFycGCisGAQQBgjcDAwExghcX
# MIIXEwYJKoZIhvcNAQcCoIIXBDCCFwACAQMxDzANBglghkgBZQMEAgEFADCCAVkG
# CyqGSIb3DQEJEAEEoIIBSASCAUQwggFAAgEBBgorBgEEAYRZCgMBMDEwDQYJYIZI
# AWUDBAIBBQAEINgWrUota0ZHNfSFjiWDluuD0u0+31MV2DzqeZeSTS4JAgZj91lq
# P4MYEzIwMjMwMjI3MDkyMDQ3LjczOFowBIACAfSggdikgdUwgdIxCzAJBgNVBAYT
...
# AQkEMSIEIAYjpIBW07EYZe34CyIj0W2IPQDJ9qu3ldg5qc6fzT7EMIH6BgsqhkiG
...
# IMDM0DANBgkqhkiG9w0BAQsFAASCAgCZofmqkQBytqm7qEgsxVuWydE7PD/NctRF
# Sc8Is4civk4AuE4Y4AQXGskIH2hwdhe7L0LTANse0S9ijKO8OMgFC1TcR3Ubz2Ak
# QDe49uvKl0QHJkdF05ehPhK3t63exWc0BbnjU/RjEPeWuzgx81aOp62Ngsu/p0I9
# qvnk8Du5LcHpErRpCEOYYfSavdMEq9CGUdbhzTuMfdDXe3xSBw6CRwA63GTkKImO
# 8fe3J5Fr3qRGfVFyyG6ZqjwxgXJQ/zFGcpemYvQ2/LIjj0onZd+Kq23Qbtuh2CEY
# mVM1Dt8Ce+L3ma+bYGoYMezTV6bnXc3ZMEPg7qfyD8L5fcY6+UAz5EvrI3lW6iNv
# RCZSl3Jt26aCybdL9C1Hu9TYDWXPmBJo5pXQgoEdFGA02sP7lOWd5ZneNKV7HyIv
# tGRRBynJPuCWOVC1SmBE3WUuMB5HpiRdBGzFYuAhInzua3rjVRuZyMaLbtkxhv19
# 1SjXg81UnKPQREmgue2WlamGHTRuSDXOrU4IHw9kJoyb5A/NyNwMdb9o/s0bLbwE
# GUGgdfL9p0wQ1ikbQ3dQelSwGz2iBdSlOOMtM4Auu+kfXEwCPlh/1D8uMLDD6UCO
# wMMXtBxhbIq6vODHHQRhrXNDbigp52poQ1gKxWBVcygOgH27eSJ4HnuXncB576Ho
# nI7MKHkQrA==
