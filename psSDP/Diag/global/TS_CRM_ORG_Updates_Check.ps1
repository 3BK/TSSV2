# To check organizations that are not updated on the CRM server.
#
...
Write-DiagProgress -Activity $LocalizedMessages.PROGRESSBAR_ID_CRM_ORG_UPDATE_CHECK -Status $LocalizedMessages.PROGRESSBAR_ID_CRM_ORG_UPDATE_CHECKDesc

"--> Entered TS_CRM_ORG_UPDATES_CHECK.ps1" | WriteTo-StdOut
	...
	if ($MSCRMKey -ne $null){
		...
		foreach ($dr in $crm_organization_versions)
		{
			if ($dr.GetType() -ne [System.Int32] -and [System.Data.DataRow]$dr){
				if ($dr.Revision -lt [System.Convert]::ToInt32($revision)){
					Write-GenericMessage -RootCauseID "RC_CRMOrganization_Not_Updated" -Verbosity "Error" -SolutionTitle ([System.String]::Format("The Microsoft CRM Organization {0} has a Revision of {1}.  The organization should be updated to {2} so all database updates have been applied to this organization.",$dr.FriendlyName,$dr.Revision,$revision)) -ProcessName "W3WP.exe"
...
if ($RootCauseDetected -eq $true){
	Update-DiagRootCause -Id "RC_CRMOrganization_Not_Updated" -Detected $true 
	if ($Error.Count -gt 0)	{
		("ERROR=" + $Error) | WriteTo-StdOut
	}
}	
else{
	Update-DiagRootCause -Id "RC_CRMOrganization_Not_Updated" -Detected $false 
}
"<-- Exited TS_CRM_ORG_UPDATES_CHECK.ps1" | WriteTo-StdOut

# SIG # Begin signature block
# MIInwwYJKoZIhvcNAQcCoIIntDCCJ7ACAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDKx5Nkn99wfR+N
# qG0gMWxsz0YWe0Jhmq4+MmAgkVTyhKCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIGGeRIaX7Yp8FTiRI/7sWKwm
# 6INr4QO4i+dzmo3yMP+HMEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCAQCfXZU37e3J50wRPhrVFiQ5PfyucNHTaFGCl9NjM1mLTUusAy9dO0ew
# h63Exx0G4LzdxkinJcK6UzZ6K2RVYRUfDY1se8mTn8ugmZFRJ5k9eLV2fnhH7WYm
# 4UYkP/VAUW0NxESCgX3lv9DwMYvMLgYDSpJig0+9J6tQ+H0AIAU265KwZQtmVPLW
# 4L7H8/kM0FDQwLsoHoCJFbbx+JwoF8PtHgnxX8kpB6jefjuHE7ppFEaN/3zSg4qb
# Lr2gtMs5hvohcpsmvj9HsAm997efFmO2Y4vOh00Saq+NYyD1KHvtVcQIVEhPVUzH
# NTEafEKWy5TEybir12TvXSdC47LBPMzEoYIXKzCCFycGCisGAQQBgjcDAwExghcX
# MIIXEwYJKoZIhvcNAQcCoIIXBDCCFwACAQMxDzANBglghkgBZQMEAgEFADCCAVkG
# CyqGSIb3DQEJEAEEoIIBSASCAUQwggFAAgEBBgorBgEEAYRZCgMBMDEwDQYJYIZI
# AWUDBAIBBQAEIEbBxYF9rgRrNn2zRMYwDBKm00BtIyA+aZYxm2lL6MIOAgZj91lq
# Pg0YEzIwMjMwMjI3MDkyMDQxLjYzMlowBIACAfSggdikgdUwgdIxCzAJBgNVBAYT
...
# AQkEMSIEINglDhEkkWbHNUfNLQlRcmHVL16BmD822xImB8DMAST9MIH6BgsqhkiG
...
# IMDM0DANBgkqhkiG9w0BAQsFAASCAgBbBQo7IBcqqMBSqd6r9pBwWfyl2V79QBFs
# czsMp0DKx96hBHcrABf/9lM7LbfpFN8jiRMiY6MssZ/neh+Eox5k/QI/LmTzsh1X
# BrnmqUy6aN5kc0lLI0hqM727NaWFYLJGWPUGmnB5lX2ZPyQf66bBOLn+74e2pPA/
# ySrcEvb6fSxp9qBUORahBRMGbyBlGo+7iHc/kJ9hyiJHEl75ZL/F9iERqrAp6JwV
# ANAc2T9fNf5WXE4rRmBUwarVQmHQlI6e+6asvyz+G1E3AQVRNWdnHkhCDSUM5LXT
# Oo29dmUh9It5ldX68zc2qqaqaZ1m7AS1ZMc+w19UIcX/g3JR/TPMgmNjf5N1Vlft
# +MWv8j5R3OeRsq4VqQpwENlMgLqHZOOnTyXv3BOAIQM2NE2LEKOVmpUlQmSJK1o2
# YcMmIAVnqJ2ZoVd4qHIPrpOR2L9BX0QHxNNx4afwMVauHQpumkLa72OjdQjDtIgM
# FOu387q4l1fQqa8IXMwxTwzzeJ2XEKpvPRnE0VqO9aipXeU5Izcg3c4oFvfP8Cch
# tVJb8+pIk4pE4co1MPp22X2F37Zx6cY3sLpmEhDz1F5/wk0d1NI89GUvveaf5DUN
# q4OekNlKKti16JWbvGQ9Kah/BBXSGev6Wz9Yf7Tr9Qs7sw/JQqwLEGbawRD/88EY
# vEcgOB09qw==
