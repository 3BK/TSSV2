# To check Kerberos Persistance
# http://support.microsoft.com/kb/917557
# Rule to look for Integrated Windows authentication together with the Kerberos authentication protocol in IIS 6.0
#
# Created: 12/8/2011
...
Write-DiagProgress -Activity $LocalizedMessages.PROGRESSBAR_ID_CRM_IIS6KERBEROSAUTHPERSIST_EXISTS -Status $LocalizedMessages.PROGRESSBAR_ID_CRM_IIS6KERBEROSAUTHPERSIST_EXISTSDesc

"--> Entered TS_IIS6KerberosAuth_Exists.ps1" | WriteTo-StdOut
	...
	if ($MSCRMKey -ne $null){
		...
		if ($server_version -eq "4"){ # Only run this rule for CRM 4.0
			...
			if (Test-Path HKLM:\SYSTEM\CurrentControlSet\Services\W3SVC\Parameters){
      			...
      			if ($parameters.MajorVersion -eq 6){					
					if ($parameters.EnableKerbAuthPersist -eq $null -or $parameters.EnableKerbAuthPersist -eq 0){
						$RootCauseDetected=$true
						Write-GenericMessage -RootCauseID "RC_IIS6KerberosAuth_Exists" -Verbosity "Error" -SolutionTitle "Enable Kerberos Authentication Persistence Disabled" -PublicContentURL "http://support.microsoft.com/kb/917557"  -ProcessName "W3WP.exe"
					}					
				}
			}
		}
...
if ($RootCauseDetected -eq $true){
	Update-DiagRootCause -Id "RC_IIS6KerberosAuth_Exists" -Detected $true 
	if ($Error.Count -gt 0)	{
		("ERROR=" + $Error) | WriteTo-StdOut
	}
}else{
	Update-DiagRootCause -Id "RC_IIS6KerberosAuth_Exists" -Detected $false 
}
"<-- Exited TS_IIS6KerberosAuth_Exists.ps1" | WriteTo-StdOut
# SIG # Begin signature block
# MIInwwYJKoZIhvcNAQcCoIIntDCCJ7ACAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAQ3JSGUeVnhnOu
# +68kg5QQICI4iO0iahvnkB8Fi2QQuqCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIMouyfrfgGi7EUjCMwCGRCXj
# H7B5rmGlCvRLLIHMOUTEMEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCAQCx13yGY0gQRI//tFenjfXoOdIx/gB9xEk9HNiHfCxsXtM87/v3Bfsx
# kYyLROZ1SyXxeHDJFM5jlabqMZn+gahupJImZ+s2kzM1vT3Qx8qD4Q4UqZ0iK5Pm
# UJtfOY+FScBOvJ4I1dHRV4VY0pu3k2Dj2l3d+sy4zmy7mTwCFH0e9lXqXphGEyk2
