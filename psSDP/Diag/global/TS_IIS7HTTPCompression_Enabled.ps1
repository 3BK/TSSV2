# To check for HTTP Compression in IIS 7
# 
# Rule to check for HTTP Compression settings in IIS 7.x and 8.0
#
# Created: 3/14/2012
...
Write-DiagProgress -Activity $LocalizedMessages.PROGRESSBAR_ID_CRM_IIS7HTTPCOMPRESSION_ENABLED -Status $LocalizedMessages.PROGRESSBAR_ID_CRM_IIS7HTTPCOMPRESSION_ENABLEDDesc

"--> Entered TS_IIS7HTTPCompression_Enabled.ps1" | WriteTo-StdOut
		...
		if ($server_version -eq "5" -or $server_version -eq "6"){ # Only run this rule for CRM 2011
			...
			if (Test-Path HKLM:\SYSTEM\CurrentControlSet\Services\W3SVC\Parameters){
      			...
      			if ($parameters.MajorVersion -eq 7 -or $parameters.MajorVersion -eq 8){
					...
					$http_compression_section = $config.GetSection("system.webServer/httpCompression")
					$dynamic_types_collection = $http_compression_section.GetCollection("dynamicTypes")
					foreach ($dynamic_type in $dynamic_types_collection){
						$mime_type=$dynamic_type.GetAttribute("mimeType")
						if ($mime_type.Value -eq "application/soap+xml;charset=utf-8" -or $mime_type.Value -eq "application/soap+xml; charset=utf-8" ){
...
if ($RootCauseDetected -eq $true){
	Update-DiagRootCause -Id "RC_IIS7HTTPCompression_Enabled" -Detected $true 
	if ($Error.Count -gt 0)	{
		("ERROR=" + $Error) | WriteTo-StdOut
	}
}else{
	Update-DiagRootCause -Id "RC_IIS7HTTPCompression_Enabled" -Detected $false 
}
"<-- Exited TS_IIS7HTTPCompression_Enabled.ps1" | WriteTo-StdOut

# SIG # Begin signature block
# MIInwwYJKoZIhvcNAQcCoIIntDCCJ7ACAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAGRfx4uQ98SY/i
# ItpWQYbu8zaYxKG2BXGeu9YVZB/QAKCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIG5I5wVf0wnBgY3K+AXmARAD
# /MsiRjj/yyFvr9rfthBOMEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCAQCWF3YjqJTXVd2Ak5aSaiLmj3dp18W8xyMdF5Xhpwj9xTvblds1THof
# TiNynJfRlSv3X+9dmcdaPr8ZVKX1qkKDzk7S3qYhq9qKhjtqp/JtiBUue81xZMFH
# OUN5wMXGXKGcTtgh2DJnna304WakgrmqjoX2GvmsUAPuzRYP0BQenOZOWgO8Q14c
