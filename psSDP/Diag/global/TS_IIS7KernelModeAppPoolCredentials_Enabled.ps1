# To check useKernelMode and useAppPoolCredentials For IIS 7
...
Write-DiagProgress -Activity $LocalizedMessages.PROGRESSBAR_ID_CRM_IIS7KERNELMODE_ENABLED -Status $LocalizedMessages.PROGRESSBAR_ID_CRM_IIS7KERNELMODE_ENABLEDDesc

"--> Entered TS_IIS7KernelModeAppPoolCredentials_Enabled.ps1" | WriteTo-StdOut
$Error.Clear()				
	...
	if ($MSCRMKey -ne $null){
		...
		if ($server_version -eq "5" -or $server_version -eq "6"){ # Only run this rule for CRM 2011
			...
			if (Test-Path HKLM:\SYSTEM\CurrentControlSet\Services\W3SVC\Parameters){
      			...
      			if ($parameters.MajorVersion -eq 7 -or $parameters.MajorVersion -eq 8){
					...
					if (-not $useKernelMode_enabled){
						$RootCauseDetected=$true
						Write-GenericMessage -RootCauseID "RC_IIS7KernelModeAppPoolCred_Enabled" -Verbosity "Error" -SolutionTitle "Microsoft Dynamics CRM 2011 continuously prompts for credentials when it attempts to access a webresource" -PublicContentURL "http://support.microsoft.com/kb/2536453"  -ProcessName "W3WP.exe" 
					}
					#Check for useAppPoolCredentials also
					...
					if (-not $useAppPoolCreds_enabled){
						$RootCauseDetected=$true
						Write-GenericMessage -RootCauseID "RC_IIS7KernelModeAppPoolCred_Enabled" -Verbosity "Error" -SolutionTitle "Microsoft Dynamics CRM 2011 continuously prompts for credentials when it attempts to access a webresource" -PublicContentURL "http://support.microsoft.com/kb/2536453"  -ProcessName "W3WP.exe" 
					}										
				}
...
if ($RootCauseDetected -eq $true){
	Update-DiagRootCause -Id "RC_IIS7KernelModeAppPoolCred_Enabled" -Detected $true 
	if ($Error.Count -gt 0){
		("ERROR=" + $Error) | WriteTo-StdOut
	}
}else{
	Update-DiagRootCause -Id "RC_IIS7KernelModeAppPoolCred_Enabled" -Detected $false 
}
"<-- Exited TS_IIS7KernelModeAppPoolCredentials_Enabled.ps1" | WriteTo-StdOut

# SIG # Begin signature block
# MIInwwYJKoZIhvcNAQcCoIIntDCCJ7ACAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAIt6AwiU9fYdbx
# i99oYaIukoIWLC+t1LbJO/wmu8QJ7aCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIIZCV7C+m639ctQbpLP4jrlU
# I0li+qvhfoBeI2riin37MEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdK