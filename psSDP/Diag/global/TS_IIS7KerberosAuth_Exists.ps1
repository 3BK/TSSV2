# To check Kerberos Persistance For IIS 7
# http://support.microsoft.com/kb/954873
# Rule to look for Integrated Windows authentication together with the Kerberos authentication protocol in IIS 7.0 and 7.5
#
# Created: 12/13/2011
...
Write-DiagProgress -Activity $LocalizedMessages.PROGRESSBAR_ID_CRM_IIS7KERBEROSAUTHPERSIST_EXISTS -Status $LocalizedMessages.PROGRESSBAR_ID_CRM_IIS7KERBEROSAUTHPERSIST_EXISTSDesc

"--> Entered TS_IIS7KerberosAuth_Exists.ps1" | WriteTo-StdOut
$Error.Clear()				
...
if (Test-Path HKLM:\Software\Microsoft\MSCRM){
	...
	if ($MSCRMKey -ne $null){
		...
		if ($server_version -eq "5" -or $server_version -eq "6"){ # Only run this rule for CRM 2011
			#Get IIS Version
			if (Test-Path HKLM:\SYSTEM\CurrentControlSet\Services\W3SVC\Parameters){
      			...
      			if ($parameters.MajorVersion -ne 6){ #Looks for IIS 7.x or 8
					...
					$windows_auth_enabled = $iisHost.GetSection("system.webServer/security/authentication/windowsAuthentication").GetAttributeValue("authPersistNonNTLM")
					if (-not $windows_auth_enabled){
						$RootCauseDetected=$true
						Write-GenericMessage -RootCauseID "RC_IIS7KerberosAuth_Exists" -Verbosity "Error" -SolutionTitle "Enable Kerberos Authentication Persistence Disabled" -PublicContentURL "http://support.microsoft.com/kb/954873"  -ProcessName "W3WP.exe" 
					}
...
if ($RootCauseDetected -eq $true){
	Update-DiagRootCause -Id "RC_IIS7KerberosAuth_Exists" -Detected $true 
	if ($Error.Count -gt 0){
		("ERROR=" + $Error) | WriteTo-StdOut
	}
}else{
	Update-DiagRootCause -Id "RC_IIS7KerberosAuth_Exists" -Detected $false 
}
"<-- Exited TS_IIS7KerberosAuth_Exists.ps1" | WriteTo-StdOut

# SIG # Begin signature block
# MIInwwYJKoZIhvcNAQcCoIIntDCCJ7ACAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDRJPTsEs6S0dKO
# eEqrqJJ2I/bks9dIVhHqK3+NmqYnlqCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIAd5+UgsVqo5upRvdo2+JfUS
# qoeaPvd8TzB4DWYDSCsEMEQGCisGAQQBgjcCAQwxNjA0oBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQuY29tIDANBgkqhkiG9w0B
# AQEFAASCAQA+jfXckD6XDVPWn14RuVdutzVblf/kfwYtLiJenH39CkqphjS3LGnS
# V1eM5PrvnJZEYFdw7SAFSvHK4vQ8utgm6E1P+LAruxxMz0nFTrcxckluMGdBlKHb
